                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/shangchengxitong/upload/yonghuMuBan.xls"
                        >批量导入用户数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('yonghu','导入导出')"
                                style="display: inline-block"
                                action="shangchengxitong/file/upload"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('yonghu','修改')" type="primary" icon="el-icon-edit" size="mini" @click="dongjiejiedong(scope.row.id,scope.row.yonghuTypes)">{{scope.row.yonghuTypes==1?'冻结':'解冻'}}</el-button>
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
			...
			dongjiejiedong(id,yonghuTypes){
				...
				this.$confirm(`确定进行`+zhi+`账号的操作吗?`, "提示", {
				    confirmButtonText: "确定",
				    cancelButtonText: "取消",
				    type: "warning"
				}).then(() => {
