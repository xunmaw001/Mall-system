    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='goods' ">
                    <el-form-item class="input" v-if="type!='info'"  label="是否促销" prop="cuxiaoValue">
                        <el-input v-model="goodsForm.cuxiaoValue"
                                  placeholder="是否促销" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="是否冻结" prop="yonghuValue">
                        <el-input v-model="yonghuForm.yonghuValue"
                                  placeholder="是否冻结" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="是否冻结" prop="yonghuValue">
                            <el-input v-model="ruleForm.yonghuValue"
                                      placeholder="是否冻结" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
